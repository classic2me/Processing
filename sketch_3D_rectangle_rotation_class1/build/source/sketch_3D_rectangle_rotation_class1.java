...
public class sketch_3D_rectangle_rotation_class1 extends PApplet {
...
public void center_cube(Coord[] r) {
  int i;
  int xCenter = 0;
  int yCenter = 0;
  int zCenter = 0;
...
public static Coord rot_deg(Coord p, float deg) {
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "sketch_3D_rectangle_rotation_class1" };
    if (passedArgs != null) {
